...
class ProductTable(models.Model):
    ...
    blueid = models.ForeignKey(BlueTable, models.DO_NOTHING, db_column='blueID')  # Field name made lowercase.
    orangeid = models.ForeignKey(OrangeTable, models.DO_NOTHING, db_column='orangeID')  # Field name made lowercase.
    whiteid = models.ForeignKey('WhiteTable', models.DO_NOTHING, db_column='whiteID')  # Field name made lowercase.
    brownid = models.ForeignKey(BrownTable, models.DO_NOTHING, db_column='brownID')  # Field name made lowercase.
    yellowid = models.ForeignKey('YellowTable', models.DO_NOTHING, db_column='yellowID')  # Field name made lowercase.
    redid = models.ForeignKey('RedTable', models.DO_NOTHING, db_column='redID')  # Field name made lowercase.
    grayid = models.ForeignKey(GrayTable, models.DO_NOTHING, db_column='grayID')  # Field name made lowercase.
    beigeid = models.ForeignKey(BeigeTable, models.DO_NOTHING, db_column='beigeID')  # Field name made lowercase.
